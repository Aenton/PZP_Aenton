...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while ( Nochmal.equals("ja")) {
                //ab hier übergeordnete WhileSchleife solange "Nochmal=ja" true ist wird weiter abgefragt
            System.out.print("Eine Zahl unter 100 Mio!: ");
            ...
            Nochmal = Waskommt.next();
                /*
                hier reagiert die nun folgende WhileSchleife darauf,ob nun "ja","nein" oder "else" kommt
